      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-300">
              <li><Link href="/"><span className="hover:text-[hsl(24,100%,48%)] transition-colors duration-200 cursor-pointer">About Us</span></Link></li>
              <li><a href="#" className="hover:text-[hsl(24,100%,48%)] transition-colors duration-200">Careers</a></li>
              <li><Link href="/blog"><span className="hover:text-[hsl(24,100%,48%)] transition-colors duration-200 cursor-pointer">Blog</span></Link></li>
              <li><Link href="/contact"><span className="hover:text-[hsl(24,100%,48%)] transition-colors duration-200 cursor-pointer">Contact</span></Link></li>
            </ul>
          </div>
        </div>
