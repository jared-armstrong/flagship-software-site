...
export default function Products() {
  useEffect(() => {
    document.title = "Products - Flagship Software";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute("content", "Explore Flagship Software's innovative product suite including DataFlow Pro, ConnectHub, AI Insights, and more cutting-edge solutions.");
    }
  }, []);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          ...
          <div className="max-w-3xl mx-auto">
            <p className="text-xl text-[hsl(0,0%,52.5%)] leading-relaxed">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {products.map((product) => {
            ...
            return (
              <div key={product.id} className="bg-white rounded-2xl shadow-lg p-8 card-hover border border-gray-100">
                ...
                <p className="text-[hsl(0,0%,52.5%)] mb-6">{product.description}</p>
