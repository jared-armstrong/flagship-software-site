...
export default function Blog() {
  useEffect(() => {
    document.title = "Blog - Flagship Software";
    const metaDescription = document.querySelector('meta[name="description"]');
    if (metaDescription) {
      metaDescription.setAttribute("content", "Read the latest insights, tutorials, and perspectives from Flagship Software on software design, development, and technology trends.");
    }
  }, []);
